...
/**
  ...
  * @brief Saves an element to a file as binary data. Specifically designed for Celeste map data.
  */
...
/**
  ...
  * @brief Loads an element from a file made of binary data. Specifically designed for Celeste map data.
  */
...
/**
  ...
  * @brief Saves an attribute from it's iterator (the key value)
...
/**
  ...
  * @param e The element to load to.
  * @brief Uses a byte integer to identify the type of attribute
  * 0:bool 1:uint8_t 2:uint16_t 3:uint32_t 4:float 5:lookup string (integer) 6: string 7: length encoded string
  */
...
/**
  ...
  * @brief Detects the type of the std::any and gets it as a celeste compatible binary identifier (see LoadAttribute)
  */
...
/**
  ...
  * @brief Loads an element from a compatible file in the Celeste format.
  */
...
/**
  ...
  * @brief Saves an element to a celeste compatible XML file.
  */
...
/**
  ...
  * @brief Creates a table of string names from an element.
