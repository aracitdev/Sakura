...
/**
  ...
  * @brief Loads a value from a binary stream.
  */
template <class T>
...
/**
  ...
  * @brief Loads a value from a stream and returns it.
  */
template <class T>
...
/**
  ...
  * @brief Saves a value to a stream.
  */
template <class T>
...
/**
  ...
  * @brief Reads count bytes from the stream and returns it as a vector of characters.
  */
...
/**
  ...
  * @brief A platform agnostic way of checking if a file exists or not.
  */
...
/**
  ...
  * @brief Reads a string encoded in the C# format from the stream.
...
/**
  ...
  * @brief Saves a string to a file stream in the C# encoded format (check ReadString for details).
  */
void WriteString(std::ostream& out, const std::string& v);

/**
  * @param path The path to create.
  * @brief A platform agnostic way of creating paths.
