...
/**
  * @brief Holds a collection of object tiles.
...
/**
  ...
  * @brief Constructs it from a CSV string.
  */
    ObjTiles(const std::string& csv);

/**
  * @param e The element to load form.
  * @brief Loads a group of object tiles from the element's innnerText.
  */
    ObjTiles(Element* e);
...
/**
  ...
  * @brief Loads a group of object tiles from the element's innerText.
...
/**
  ...
  * @return true On success, false on failure.
  * @brief Loads a set of tiles from a list of comma separated values.
...
/**
  * @brief Saves the group of tiles to an element's innertext.
...
/**
  ...
  * @brief Creates a string that's equivalent of the group of object tiles.
...
/**
  ...
  * @brief Gets an object tile from the tile group.
  */
...
/**
  ...
  * @brief Sets an object tile in the tile group.
  */
...
/**
  ...
  * @brief Resizes the tile group to fit the given size.
