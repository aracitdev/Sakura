...
/**
  ...
  * @brief Saves an Element to an XML file.
  */
...
/**
  ...
  * @brief Loads an Element from an XML file.
  */
...
/**
  ...
  * @brief Gets the name of the module an element belongs to.
