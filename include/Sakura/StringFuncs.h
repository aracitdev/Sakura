...
/**
  ...
  * @brief Separates a string into a 2D array.
...
/**
  ...
  * @brief Separates a string into multiple character arrays (strings), broken apart by the delimiter character.
  */
...
/**
  ...
  * @param delimiter The separating character for tokens.
  * @return The split up strings.
  * @brief Separates a string into multiple strings, broken apart by the delimiter character.
  */
...
/**
  ...
  * @brief Replaces all instances of search with replace in the string subject.
  */
